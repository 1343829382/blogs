                    ...
                    <div class="wrap-col">
                        <article>
                            <div class="heading">
                                <h2>${blog.title}</h2>
                                <p></p>
                                <h5>作者:${admin.name}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;时间:<fmt:formatDate value="${blog.date}" type="date" pattern="yyyy-MM-dd HH:mm"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;阅读:16</h5>
                            </div>
                            <div class="content">
                                <p>${blog.content}</p>
                            </div>
                        ...
                        <section>
                            ...
                            <form id="contact-form" method="post">
                                <fieldset>
                                    <label><input name="email" value="邮箱" onBlur="if(this.value=='') this.value='Email'" onFocus="if(this.value =='Email' ) this.value=''" /></label>
                                    <label><input name="subject" value="姓名" onBlur="if(this.value=='') this.value='Subject'" onFocus="if(this.value =='Subject' ) this.value=''" /></label>
                                    <textarea onBlur="if(this.value=='') this.value=''" onFocus="if(this.value =='Message' ) this.value=''">内容</textarea>
                                    <div class="buttons">
