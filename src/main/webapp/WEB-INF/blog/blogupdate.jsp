        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input style="width: 1000px;height: 35px;" type="text" id="title" name="title" value="${blog.title}" required="" lay-verify="required" autocomplete="off" class="layui-input"></div>
            </div>
            <div class="layui-form-item">
                <label style="margin: -5px 0; font-size: 15px;" for="keyword" class="layui-form-label">
                    <span class="x-red"></span>关键词</label>
                <div class="layui-input-inline">
                    <input style="width: 1000px; height: 35px;" type="text" id="keyword" name="keyword" value="${blog.keyword}" required="" lay-verify="required" autocomplete="off" class="layui-input"></div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select id="cid" name="cid" style="display: block;width: 200px;height: 35px">
                        <fc:forEach items="${category}" var="user">
                            <option value="${user.id}" <fc:if test="${blog.cid == user.id}">selected="selected"</fc:if>>${user.typename} </option>
                        </fc:forEach>
                    </select>
                </div>
            </div>
...
console.log(editor);
        $.ajax({
           type:"post",
           url:"${ctx}/admin/blog/update",
           dataType:"json",
           data:{
               id:id,title:title,keyword:key,content:editor,cid:cid
           },
